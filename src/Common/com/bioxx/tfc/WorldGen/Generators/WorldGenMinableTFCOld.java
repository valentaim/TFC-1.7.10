...
public class WorldGenMinableTFCOld extends WorldGenerator
{
	...
	public WorldGenMinableTFCOld(Block block, int j)
	{
		//int emptyHolder = 0;
		minableBlock = block;
		minableBlockMeta = 0;
	...
	public WorldGenMinableTFCOld(Block block, int j, Block layerB, int layerMeta, int rarity, int veinSize,
